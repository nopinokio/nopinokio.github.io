(function ($) {
    ...
    // Caption
    $('.cont_container .article').each(function(i) {
        $(this).find('img').each(function() {
            ...
            if ($(this).parent().prop("tagName") !== 'A') {
                $(this).wrap('<div class="gallery_block"><a href="' + this.src + '" title="' + this.alt + '" class="gallery-item"></a></div>');
            }
        });
    ...
    if (typeof lightGallery != 'undefined') {
        ...
        $('.cont_container .article').each(function(i, entry) {
    ...
    $('.tt_category .sub-list .sub-list-link, .tt_category .link_tit').each(function () {
